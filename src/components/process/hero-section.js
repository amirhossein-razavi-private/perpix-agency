...
export function ProcessHeroSection({ t }) {
  return (
    <section className="relative overflow-hidden pt-16 lg:pt-[72px] trust-hero-bg mesh-bg">
      <div
        className="absolute top-1/4 start-[-8%] w-[520px] h-[520px] rounded-full opacity-40 dark:opacity-20 pointer-events-none float-main"
        style={{
          background:
